...
/**
 *  The purpose of this program is to load data histogram data 
 *  from .his format (ORNL / DAMM).
 *  Program parses options given by user (@see Options class) and creates
 *  @see HisDrrHisto class which loads the data and puts them into cout.
 *
 *     USAGE:  
